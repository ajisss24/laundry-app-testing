        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center">
                ...
                <div class="w-full lg:w-1/2 relative">
                    <img src="outdoor_gear_before_after_1777124102179.png" alt="Hiking Gear Before After" class="rounded-[2.5rem] shadow-2xl relative z-10 w-full h-auto max-h-[600px] object-contain">
                    <!-- Decor badge -->
